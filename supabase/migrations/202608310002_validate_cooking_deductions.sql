-- Do not trust the browser's availability calculation. Validate every proposed
-- deduction against the planned recipe before changing inventory.
...
begin
  ...
  from public.recipes where id = v_plan.recipe_id and household_id = v_plan.household_id;
